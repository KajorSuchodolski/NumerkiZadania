...
public class App {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Defining range of approximation <a;b>");
            System.out.println("Type a: ");
            int a = scanner.nextInt();
            System.out.println("Type b: ");
            int b = scanner.nextInt();
            System.out.println("Type epsilon: ");
            double eps = scanner.nextInt();

            Integral integral = new Integral(0.00001, inner, outer);

            System.out.println(integral.NewtonCotes(a, b));
